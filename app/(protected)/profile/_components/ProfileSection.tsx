...
export default function ProfileSection({
    ...
    if (!userData?.email) {
        return (
            <div
                ...
                <div
                    className="mx-auto h-16 w-16 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center mb-6">
    ...
    return (
        <>
            <section>
                <div
                    className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 max-w-2xl">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center mb-8">
                        <div className="flex flex-col items-center">
                            <div className="relative mb-3">
                                {userData.profileUrl ? (
                                    ...
                                    <div
                                        className="h-28 w-28 lg:h-32 lg:w-32 rounded-2xl bg-gray-200 dark:bg-gray-700 flex items-center justify-center ring-2 ring-gray-200 dark:ring-gray-600">
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="flex gap-4 pt-2">
                                <button
                                    className="flex-1 px-6 py-3 border border-gray-300 rounded-xl text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                                    Cancel
                                </button>
                                <button
            ...
            <section className="mt-6">
                <div
                    className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 max-w-2xl">
                    ...
                    {userData.role === "UNASSIGNED" ? (
                        ...
                        <div
                            className="inline-flex items-center px-4 py-3 rounded-xl border border-blue-500 bg-blue-50 dark:bg-blue-900/20">
