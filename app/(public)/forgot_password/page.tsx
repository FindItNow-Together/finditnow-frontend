...
import {
  ...
  SendVerification,
  VerifyPasswordToken,
} from "@/app/(public)/forgot_password/FormLevelComponents";
...
export default function ForgotPassword() {
  ...
  const getFormLevelComponent = (level: FormLevel) => {
    switch (level.name) {
      case "send":
        return <SendVerification setFormLevel={setFormLevel} formLevel={formLevel} />;
      case "verify":
        return <VerifyPasswordToken setFormLevel={setFormLevel} formLevel={formLevel} />;
      case "set":
